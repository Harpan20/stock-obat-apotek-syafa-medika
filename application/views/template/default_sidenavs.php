	...
	<div class="left_col scroll-view">
		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				<h3></h3>
				<ul class="nav side-menu" style="overflow-y: auto;">

					<?php if ($user_nav['role_id'] == 1 || $user_nav['role_id'] ==  2 || $user_nav['role_id'] ==  3) { ?>
					...
					<li><a><i class="fa fa-edit"></i> Penjualan <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<?php if ($user_nav['role_id'] == 1 || $user_nav['role_id'] ==  2) { ?>
					...
					<li><a href="javascript: return false;" data-toggle="modal" data-target="#modal-logout"><i class="fa fa-sign-out"></i> Keluar </a></li>
				</ul>
			</div>
		</div>
...
<!-- Modal -->
<div class="modal fade" id="modal-logout" tabindex="-1" role="dialog" aria-labelledby="modal logout">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="modal logout">Yakin Keluar?</h4>
			</div>
			<div class="modal-body">
				Pilih tombol "Keluar" dibawah jika anda yakin
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				<button type="button" class="btn btn-primary" onclick="window.location.href='<?= base_url('auth/logout') ?>'">Keluar</button>
			</div>
		</div>
	</div>
</div>