  ...
  <div class="nav_menu">
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
          <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/caca.jpg') ?>" alt="">Selamat Datang
