			...
			<div class="right_col" role="main">
				...
				<footer>
					<div class="pull-right">
						<a href="https://instagram.com/apoteksyafa.medika?igshid=MzRlODBiNWFlZA==" title="apoteksyafamedika.com" target="_blank">Instagram : @apoteksyafa.medika</a> | Apotek Syafa Medika | </a> <?php echo $footer; ?>
					</div>
					<div class="clearfix"></div>
				</footer>
				<!-- /Footer Content -->
