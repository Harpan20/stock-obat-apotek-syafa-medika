...
$template['bootstrap']['regions'] = array(
   ...
   'content',
   'footer' => array(
        'content' => array('<p>Copyright &copy; AnnisaSucianty/p>'),
    ),
);
...
$template['default']['regions'] = array(
   'title' => array('content' => array('Apotek Syafa Medika')),
   'header',
   'content',
   'navs',
   'footer' => array(
        'content' => array('<p>Annisa Sucianty &copy; 2023</p>'),
    ),
);
...
$template['body']['regions'] = array(
   ...
   'content',
   'footer' => array(
        'content' => array('Annisa Sucianty &copy; 2023'),
    ),
);
